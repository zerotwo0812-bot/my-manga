...
?>
    <div class="c-search-header__wrapper" style="<?php echo esc_attr($search_header_background != '' ? $search_header_background : 'background-image: url(' . madara_get_default_background() . ');'); ?>">
        <div class="container">
